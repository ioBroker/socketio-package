...
**If possible, please use [`@iobroker/ws-server`](https://github.com/ioBroker/ws-server-package) instead of this package.**
...
* (@GermanBluefox) minimal Node JS version is 20
